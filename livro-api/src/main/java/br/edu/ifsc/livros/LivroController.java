...
public class LivroController {
	...
	@RequestMapping(value = "/adicionar_livro",
	...
	@RequestMapping(value = "/LivroPorIsbn/{isbn}", 
			method = RequestMethod.GET)
	...
	@RequestMapping(value = "/LivrosPorAutor/{autor}",
			method = RequestMethod.GET)
	...
	@RequestMapping(value = "/LivroPorTitulo/{titulo}", 
			method = RequestMethod.GET)
	...
	@RequestMapping(value = "/LivrodtoPorIsbn/{isbn}", 
			method = RequestMethod.GET)
	...
	@RequestMapping(value = "/ReajustarPreco/{id}/{taxa}", 
			method = RequestMethod.GET)
	...
	@RequestMapping(value = "/ReajustarPreco/{taxa}", method = RequestMethod.GET)
	public void reajustarPreco(
			@PathVariable(name = "taxa") double taxa) {
